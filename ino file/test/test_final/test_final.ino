...
void getNilaiPh(){
  ...
  pH = 7 + ((teganganPh7 - teganganSensorPh) / phStep);
}
...
void loop() {
  // memeriksa apakah masih terkoneksi dengan wifi, jika tidak menghubungkan ulang dan memeriksa kembali
//  checkWifiStatus();
//  
//  Serial.print("Flag Wifi: ");

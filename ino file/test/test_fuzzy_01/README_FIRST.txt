...
* metode fuzzy logic
    + metode fuzzyfikasi
        - metode fuzzyfikasi pada file test ini menggunakan nilai input dari sensor suhu dan ph
        - nilai fuzzyfikasi pada file test ini menggunakan 4 nilai pada masing2 nilai keanggotaan
        - pada bentuk grafik nilai keanggotaan fuzzy akan berbentuk trapesium karna menggunakan 4 nilai
    
    + aturan (rules)
        - terdapat 9 rules yang digunakan pada file test ini
...
*note :
  ...
  - Sensor suhu terhubung pada pin digital 11 arduino
